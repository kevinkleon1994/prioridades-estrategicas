...
let user=null,records=[],tasks=[],evidences=[],systemUsers=[],churchStats=[],requirements=[],churchProfiles=[],dailyVerse=null,evidenceEditMode=false,selectedChurch="Todas",selectedYear="2026",selectedMonth="Todos",deferredPrompt=null,currentPriority="Identidade",selectedCriterionCode=null,criteriaStatus="Todos";
...
function renderMyChurch(){
  ...
  $("churchPastorInput").value=p?.pastor_responsavel||"";
  ...
  ["churchEldersInput","churchFamiliesInput","churchPastorInput","churchPhoneInput","churchAddressInput","churchEmailInput","churchNotesInput","saveChurchProfileButton"].forEach(id=>$(id).disabled=disabled);
}
async function saveChurchProfileV84(){
  ...
  const payload={
    ...
    pastor_responsavel:$("churchPastorInput").value,
